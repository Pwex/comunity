...
class Export_excel_requirements_matrix{
    ...
    function to_excel($array, $filename) {
        ...
        foreach($array as $key => $row){
            ...
            $hdata[$key]['file_datasheet']         = !empty($row['file_datasheet']) ? "<a href='".$row['file_datasheet']."'>Adjunto</a>" : '';
            $hdata[$key]['opt_safety']             = $row['opt_safety'];
            $hdata[$key]['file_safety']            = !empty($row['file_safety']) ? "<a href='".$row['file_safety']."'>Adjunto</a>" : '';
            $hdata[$key]['opt_msds']               = $row['opt_msds'];
            $hdata[$key]['file_msds']              = !empty($row['file_msds']) ? "<a href='".$row['file_msds']."'>Adjunto</a>" : '';
            $hdata[$key]['opt_stability']          = $row['opt_stability'];
            $hdata[$key]['file_stability']         = !empty($row['file_stability']) ? "<a href='".$row['file_stability']."'>Adjunto</a>" : '';
            ...
            $hdata[$key]['file_label']             = !empty($row['file_label']) ? "<a href='".$row['file_label']."'>Adjunto</a>" : '';
            $hdata[$key]['opt_certificate']        = $row['opt_certificate'];
            $hdata[$key]['file_certificate']       = !empty($row['file_certificate']) ? "<a href='".$row['file_certificate']."'>Adjunto</a>" : '';
            $hdata[$key]['opt_toxicity']           = $row['opt_toxicity'];
            $hdata[$key]['file_toxicity']          = !empty($row['file_toxicity']) ? "<a href='".$row['file_toxicity']."'>Adjunto</a>" : '';
