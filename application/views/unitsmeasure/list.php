        ...
        <div class="box-header">
            <blockquote style="margin-bottom: 0">
                ...
                <span style="float: right;">
                    <a href="<?php echo base_url('unitsmeasure/add') ?>" class="btn btn-primary" title="Agregar Unidad Medida">
                ...
                <tbody>
                    <?php foreach ($full_listing as $key => $value): ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url('unitsmeasure/edit/').$value['id_unit_measure'] ?>" class="btn btn-warning">
                                    <i class="fa fa-pencil"></i>
                                </a>
                                <button type="button" class="btn btn-danger btn-delete" id="<?php echo $value['id_unit_measure'] ?>">
