    ...
    <div class="box box-warning">
        <div class="box-header">
            <blockquote style="margin-bottom: 0">
                Listado completo de usuarios<span style="float: right;"><a href="<?php echo base_url('users/add') ?>" class="btn btn-primary" title="Agregar Usuarios"><i class="fa fa-plus-circle"></i></a></span>
            </blockquote>
