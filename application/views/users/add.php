                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="name" class="form-control" placeholder="Ingresar un nombre" value="<?php echo set_value('name') ?>" required="" />
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="last_name" id="last_name" class="form-control" placeholder="Ingresar un apellido" value="<?php echo set_value('last_name') ?>" required="" />
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="email" name="email" id="email" class="form-control" placeholder="Ingresar un correo electrónico" value="<?php echo set_value('email') ?>" required="" />
