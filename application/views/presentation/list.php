        ...
        <div class="box-header">
            ...
            <blockquote style="margin-bottom: 0">
                ...
                <span style="float: right; margin-top: -4px;">
                    <a href="<?php echo base_url('presentation/add') ?>" class="btn btn-primary" title="Agregar Beneficio">
            ...
            <table class="table table-responsive table-bordered table-hover" id="table-default">
                ...
                <tbody>
                    <?php foreach ($full_listing as $key => $value): ?>
                        <tr>
                            <td><?php echo $value['id_presentation'] ?></td>
                            <td><?php echo $value['name_presentation'] ?></td>
                            <td>
                                <div class="btn-group btn-group-justified">
                                    <a href="<?php echo base_url('presentation/edit/').$value['id_presentation'] ?>" class="btn btn-warning btn-sm">
                                        <i class="fa fa-pencil"></i>
                                    </a>
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-danger btn-delete btn-sm" id="<?php echo $value['id_presentation'] ?>">
