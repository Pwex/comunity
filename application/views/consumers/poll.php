...
<section class="content">
    <div class="box box-danger">
        ...
        <div class="box-body">
            ...
            <p></p>
            <div class="row">
                <label for="not_eat">Sufre de alguna de estas enfermedades?</label>
            </div>    
            <div class="row">
                <div class="row setup-content" id="step-9">
                    <div class="col-md-12 no-padding">
                        <div class="btn-group add-check" data-toggle="buttons">
                            <label class="btn btn-default btn-check-main50" style="border-top-left-radius: 2px; border-bottom-left-radius: 2px;">Diabetes
                            ...
                            <label class="btn btn-default btn-check-main50">Colesterol alto
            ...
            <p></p>
            <div class="row">
                <label for="not_eat">Cuántas veces come al día?</label>
            </div>    
            <div class="row">
                <div class="row setup-content" id="step-9">
                    <div class="col-md-12 no-padding">
