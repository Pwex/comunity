    ...
    <div class="box box-danger">
        <div class="box-header">
            ...
            <blockquote style="margin-bottom: 0">
                Listado de Tipos Movimiento
                <span style="float: right; margin-top: -4px;">
                    <a href="<?php echo base_url('movement_types/add') ?>" class="btn btn-primary" title="Crear tipo movimiento">
            ...
            <table class="table table-responsive table-bordered table-hover" id="table-default">
                ...
                <tbody>
                    <?php foreach ($full_listing as $key => $value): ?>
                        <tr>
                            <td><?php echo $value['id_movement_type'] ?></td>
                            <td><?php echo $value['movement_type'] ?></td>
                            <td>
                                <a href="<?php echo base_url('movement_types/edit/').$value['id_movement_type'] ?>" class="btn btn-warning btn-sm">
                                    <i class="fa fa-pencil"></i>
                                </a>
                                <button type="button" class="btn btn-danger btn-delete btn-sm" id="<?php echo $value['id_movement_type'] ?>">
