                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <?php echo form_dropdown('id_country_price', $country, set_value('id_country_price'), 'class="form-control select2" required=""'); ?>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <?php echo form_dropdown('id_product_price', $products, set_value('id_product_price'), 'class="form-control select2" required=""'); ?>
