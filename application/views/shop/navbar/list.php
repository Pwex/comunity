        ...
        <div class="box-header">
            ...
            <blockquote style="margin-bottom: 0">
                ...
                <span style="float: right; margin-top: -4px;">
                    <a href="<?php echo base_url('shop-layout-navbar/organize') ?>" class="btn btn-default" title="Organizar Menús">
                        <i class="fa fa-bars"></i>
                    </a>
                    <a href="<?php echo base_url('shop-layout-navbar/add') ?>" class="btn btn-primary" title="Agregar Menús">
            ...
            <table class="table table-responsive table-bordered table-hover" id="table-default">
                ...
                <tbody>
                    <?php foreach ($full_listing as $key => $value): ?>
                        <tr>
                            <td><?php echo $value['id_navbar'] ?></td>
                            <td><?php echo $value['navbar'] ?></td>
