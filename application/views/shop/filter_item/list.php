        ...
        <div class="box-header">
            ...
            <blockquote style="margin-bottom: 0">
                ...
                <span style="float: right; margin-top: -4px;">
                    <a href="<?php echo base_url('shop-layout-filter-item/add') ?>" class="btn btn-primary" title="Agregar Menús">
                ...
                <tbody>
                    <?php foreach ($full_listing as $key => $value): ?>
                        <tr>
                            ...
                            <td><?php echo $value['name_filter'] ?></td>
                            <td><?php echo $value['settings'] ?></td>
                            <td>
                                <div class="btn-group btn-group-justified">  
                                    <a href="<?php echo base_url('shop-layout-filter-item/edit/').$value['id'] ?>" class="btn btn-warning btn-sm">
