                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="name_partner" id="name_partner" class="form-control" value="<?php echo set_value('name_partner') ?>" required="" />
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="zip_partner" id="zip_partner" class="form-control" value="<?php echo set_value('zip_partner') ?>" />
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="address_partner" id="address_partner" class="form-control" value="<?php echo set_value('address_partner') ?>" />
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="phone_partner" id="phone_partner" class="form-control" value="<?php echo set_value('phone_partner') ?>" />
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="mobile_partner" id="mobile_partner" class="form-control" value="<?php echo set_value('mobile_partner') ?>" />
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="web_partner" id="web_partner" class="form-control" value="<?php echo set_value('web_partner') ?>" />
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="email" name="email_partner" id="email_partner" class="form-control" value="<?php echo set_value('email_partner') ?>" required="" />
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="account_partner" id="account_partner" class="form-control" value="<?php echo set_value('account_partner') ?>" />
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="name_contact_partner" id="name_contact_partner" class="form-control" value="<?php echo set_value('name_contact_partner') ?>" />
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="position_contact" id="position_contact" class="form-control" value="<?php echo set_value('position_contact') ?>" />
