...
<section class="content">
    ...
    <div class="box box-warning">
        <div class="box-header">
            <h3 class="box-title"><a href="<?php echo base_url('products/add') ?>" class="btn btn-primary btn-sm" title="Agregar Producto"><i class="fa fa-plus-circle"></i></a> | Listado de Productos</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
